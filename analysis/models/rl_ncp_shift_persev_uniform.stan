/*      Reinforcement learning model: Alpha Shift + Perseveration - UNIFORM PRIORS / NCP VERSION
Last edit:  2025/06/18
Authors:    Poth, Yannik (YP)
Notes:      - Based on rl_cp_shift_uniform.stan.
            - Implements a Non-Centered Parameterization (NCP) to improve sampling and reduce divergent transitions.
            ...
            - Hierarchical structure with Non-Centered Parameterization (NCP).
            - Interpretable alpha shift values are calculated in the generated quantities block.
To do:      - Test and validate convergence.
Comments:   - This NCP model is the first step in addressing the severe convergence issues of the CP version.
              It aims to produce reliable posterior estimates for hypothesis testing.
