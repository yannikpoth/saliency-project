/*      Reinforcement learning model: Model 5 - Kappa + Kappa Shift
Last edit:  2025/11/07
Authors:    Poth, Yannik (YP)
            Geysen, Steven (SG)
Notes:      - Factorial design model 5/6: Kappa + Kappa shift
            ...
            - Kappa_shift modulates perseveration based on salient feedback
